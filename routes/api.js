...
const CONNECTION_STRING = "mongodb+srv://raaf:araaf@cluster0.qwzqgzm.mongodb.net/?retryWrites=true&w=majority"; //MongoClient.connect(CONNECTION_STRING, function(err, db) {});

mongoose.connect("mongodb+srv://raaf:araaf@cluster0.qwzqgzm.mongodb.net/?retryWrites=true&w=majority", { useNewUrlParser: true, useCreateIndex: true });
